...
word_features5k_f = open("pickled_algos/word_featureset.pickle", "rb")
...
open_file = open("pickled_algos/original_Naive_Bayes_Classifier.pickle", "rb")
classifier = pickle.load(open_file)
open_file.close()


open_file = open("pickled_algos/Multinomial_NB_Classifier.pickle", "rb")
